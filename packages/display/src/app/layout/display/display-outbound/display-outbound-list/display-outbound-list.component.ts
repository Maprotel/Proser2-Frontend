...
// Local models
import { DisplayOutboundResponseModel } from "packages/display/src/shared/models/display-outbound/DisplayOutboundResponse.model";

// Local shared
import { DisplayOutboundGraphComponent } from "../display-outbound-graph/display-outbound-graph.component";

import { DisplayOutboundModel } from "packages/display/src/shared/models/display-outbound/DisplayOutbound.model";
import { DisplayOutboundIndicatorsService } from "packages/display/src/shared/services/display-outbound/display-outbound-indicators.service";
