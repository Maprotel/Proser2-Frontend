...
import { ExcelService } from "packages/reports/src/shared/services/helpers/excel.service";

// Local models
import { BackendResponseModel } from "packages/reports/src/shared/models/reports/backendResponse.model";

// Local shared

<<<<<<< HEAD:sections/reports/src/app/layout/reports/calls-reports/inbound-interval-report/inbound-interval-report-list/inbound-interval-report-list.component.ts
...
=======
import { CallsInboundDailyByIntervalService } from "packages/reports/src/shared/services/reports/calls/reports-inbound-interval.service";
import { CallsInboundDailyByIntervalModel } from "packages/reports/src/shared/models/reports/calls/CallsInboundDailyByInterval.model ";
>>>>>>> 4a5a830674f9ca01bcb25fd0ae523103645c3620:packages/reports/src/app/layout/reports/calls-reports/inbound-interval-report/inbound-interval-report-list/inbound-interval-report-list.component.ts
