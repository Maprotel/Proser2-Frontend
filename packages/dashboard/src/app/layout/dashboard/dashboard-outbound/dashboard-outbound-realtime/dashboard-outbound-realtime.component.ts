...
import { DashboardOutboundIndicatorsRealTimeService } from "packages/dashboard/src/shared/services";
import { DashboardOutboundResponseModel } from "packages/dashboard/src/shared/models";
