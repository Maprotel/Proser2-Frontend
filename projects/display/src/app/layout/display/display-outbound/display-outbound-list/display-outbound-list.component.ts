...
// Local models
import { DisplayOutboundResponseModel } from "projects/display/src/shared/models/display-outbound/DisplayOutboundResponse.model";

// Local shared
import { DisplayOutboundGraphComponent } from "../display-outbound-graph/display-outbound-graph.component";

import { DisplayOutboundModel } from "projects/display/src/shared/models/display-outbound/DisplayOutbound.model";
import { DisplayOutboundIndicatorsService } from "projects/display/src/shared/services/display-outbound/display-outbound-indicators.service";
...
export class DisplayOutboundListComponent implements OnInit {
  ...
  setHeaderInfo(userSelection) {
    userSelection.title = "Display de llamadas salientes";
