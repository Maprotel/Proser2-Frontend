...
// Local models
import { DisplayInboundResponseModel } from "projects/display/src/shared/models/display-inbound/DisplayInboundResponse.model";

// Local shared
import { DisplayInboundGraphComponent } from "../display-inbound-graph/display-inbound-graph.component";

import { DisplayInboundModel } from "projects/display/src/shared/models/display-inbound/DisplayInbound.model";
import { DisplayInboundIndicatorsService } from "projects/display/src/shared/services/display-inbound/display-inbound-indicators.service";
