export class OperationResumeModel {
  agent_id: number;
  agent_name: string;
  base_date: string;
  min_date: string;
  ...
  public fieldList() {
    return [
...

      {
        ...
        html: `<p>Duración <br> llamadas <br> atendidas</p>`
      },
...

      {
        ...
        html: `<p>Tiempo en <br> auxiliares</p>`
      },
      {
...

      {
        ...
        html: `<p>Tiempo en <br> asignaciones</p>`
      },
