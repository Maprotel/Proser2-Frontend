...
@Component({
  selector: "app-crud-inv-agent-plan-detail",
  templateUrl: "./crud-inv-agent-plan-detail.component.html",
  styleUrls: ["./crud-inv-agent-plan-detail.component.scss"]
})
export class CrudInvAgentPlanDetailComponent implements OnInit {
